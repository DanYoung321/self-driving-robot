...
class TurtlesimKinematics(object):
    ...
    def __init__(self):
        self.turtle1_pos_sub = rospy.Subscriber("/turtle1/pose", Pose, self.turtle1PoseCallback)
        self.turtle2_pos_sub = rospy.Subscriber("/turtle2/pose", Pose, self.turtle2PoseCallback)
